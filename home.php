...
<body class="background-color">
  ...
  <div class="container-fluid custom-container">
    <div class="row">
      <div class="col left-column pc-display">
        <form>
  ...
  <div class="sticky-bottom mobile-display">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" height="500">
          <form>
            ...
            <div class="input-group mb-2">
              <label class="input-group-text" for="header">Header</labegit add node_modules/ yourImage.png index.html package.json package-lock.json
                l>
              <select id="header" class="form-select">
                <option value="1" selected>Information</option>
                <option value="2">Warning</option>
